...
#define OQS_VERSION_TEXT "0.11.1-dev"
#define OQS_COMPILE_BUILD_TARGET "x86_64-Linux-6.11.1-zen1-1-zen"
...
#define OQS_HAZARDOUS_EXPERIMENTAL_ENABLE_SIG_STFL_KEY_SIG_GEN 1
