...
int oqs_patch_codepoints()
{
   ...
   if (getenv("OQS_CODEPOINT_X25519_MLKEM768")) oqs_group_list[32].group_id = atoi(getenv("OQS_CODEPOINT_X25519_MLKEM768"));
   if (getenv("OQS_CODEPOINT_P256_MLKEM768")) oqs_group_list[33].group_id = atoi(getenv("OQS_CODEPOINT_P256_MLKEM768"));
